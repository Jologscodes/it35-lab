...
const Register: React.FC = () => {
    ...
    const InputField = ({ label, value, setValue, type, placeholder }: { label: string, value: string, setValue: React.Dispatch<React.SetStateAction<string>>, type: string, placeholder: string }) => (
        <IonInput
            label={label}
            ...
            <IonContent className="ion-padding">
                <div className="animated-container" style={{ maxWidth: '400px', margin: '0 auto', width: '100%' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '10px' }}>
                        <img 
                            src="https://www.gifcen.com/wp-content/uploads/2022/03/pepe-the-frog-gif-1.gif" // <-- Your GIF logo path
                            alt="Logo"
